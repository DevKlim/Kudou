...
opts.Add("vsproj_name", "Name of the Visual Studio solution", "Kudou")
...
opts.Add("custom_modules", "A list of comma-separated directory paths containing custom modules to build.", "kudou")
